...
import { type TranscriptionResult, TranscriptionService } from '../services/transcriptionService.ts';
...
export class ElectronAudioRpc {
    public readonly rendererAudioRpc: ReturnType<
        typeof createElectronSideBirpc<RenderedAudioFunctions, typeof this.functions>
    >;
    ...
    public readonly functions = {
        async saveAudioBlob(
            ...
            try {
                ...
                return await audioStorage.saveAudioBlob(buffer, duration, mimeType);
            } catch (error) {
                ...
                console.error('Data instanceof Uint8Array:', data instanceof Uint8Array);
                throw error;
            }
        },
        ...
        async transcribeAudioFile(
            ...
            try {
                ...
                return await TranscriptionService.transcribe(audioFilePath, model, language, dockerImage);
            } catch (error) {
        ...
        async checkTranscriptionAvailability(dockerImage?: string): Promise<boolean> {
            return await TranscriptionService.checkImageAvailability(dockerImage);
        },
    ...
    public constructor(window: BrowserWindow) {
        this.rendererAudioRpc = createElectronSideBirpc<RenderedAudioFunctions, typeof this.functions>(
            'audioRpc',
            'audioRpc',
            window,
            this.functions
...
export type ElectronAudioFunctions = typeof ElectronAudioRpc.prototype.functions;
