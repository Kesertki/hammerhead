import { AlertCircle, AlertTriangle, Bug, Download, FileText, Info, RefreshCw, Search, Trash2 } from 'lucide-react';
...
export function Logs() {
    const { logs, loading, error, clearLogs, getLogFilePath, refresh } = useLogs();
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                            <Badge variant="secondary" className={`${LOG_LEVEL_COLORS[log.level]} text-xs px-2 py-0.5`}>
                        ...
                        {hasStack && (
                            <div className="mt-1">
                                <Button
                                    variant="ghost"
                                    size="sm"
                                    onClick={() => toggleStackTrace(log.timestamp)}
    ...
    return (
        <div className="h-full flex flex-col max-w-6xl mx-auto p-4">
            <div className="mb-4 flex-shrink-0">
                <h1 className="text-center text-3xl font-bold tracking-tight mb-1">Application Logs</h1>
                <p className="text-center text-gray-600 text-sm">View and manage application logs and console output</p>
            </div>
            ...
            <div className="mb-4 flex-shrink-0 flex justify-between items-center">
                <div className="flex items-center gap-2">
                    ...
                    {!showControls && (searchTerm || selectedLevel !== 'all') && (
            ...
            <Card className="flex-1 flex flex-col min-h-0">
                <CardHeader className="flex-shrink-0 pb-4">
                    <div className="flex justify-between items-center">
                        <CardTitle className="text-lg">Log Entries ({filteredLogs.length})</CardTitle>
                        ...
                        <div className="h-64 flex items-center justify-center text-center text-gray-500">
                            {logs.length === 0 ? (
                                ...
                                <div>
                                    ...
                                    <p className="text-sm">Try adjusting your search term or level filter</p>
                                </div>
                            )}
                        </div>
                    )}
