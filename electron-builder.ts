...
const appId = 'hammerhead.denys.dev';
const productName = 'Hammerhead';
const executableName = 'hammerhead';
const appxIdentityName = 'hammerhead.denys.dev';
...
export default {
    ...
    mac: {
        ...
        extendInfo: {
            ...
            NSCameraUsageDescription: 'This application may require camera access for video input.',
        },
